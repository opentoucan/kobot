...
dependencies {
    ...
    testImplementation("io.kotest:kotest-runner-junit5-jvm:6.0.7") // for kotest framework
    testImplementation(
        "io.kotest:kotest-assertions-core-jvm:6.0.7",
    ) // for kotest core jvm assertions
    testImplementation("io.kotest:kotest-property-jvm:6.0.7") // for kotest property test
