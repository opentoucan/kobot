...
dependencies {
    implementation("org.springframework.boot:spring-boot-starter-data-mongodb:3.5.9")
    ...
    implementation("org.springframework.boot:spring-boot-starter-amqp:3.5.9")
