...
dependencies {
    implementation("org.springframework.boot:spring-boot-starter-data-mongodb:3.5.10")
    ...
    implementation("org.springframework.boot:spring-boot-starter-amqp:3.5.10")
    developmentOnly("org.springframework.boot:spring-boot-devtools:3.5.10")
