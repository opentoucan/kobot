...
dependencies {
    implementation("org.springframework.boot:spring-boot-starter-data-mongodb:3.5.8")
    ...
    implementation("org.springframework.boot:spring-boot-starter-amqp:3.5.8")
    developmentOnly("org.springframework.boot:spring-boot-devtools:3.5.8")
    annotationProcessor("org.springframework.boot:spring-boot-configuration-processor:3.5.8")
