...
class GuildMessageListener(
    ...
    override fun onGuildVoiceUpdate(event: GuildVoiceUpdateEvent) {
        ...
        // Return if the event is triggered by the bot or by someone leaving a channel in a guild we
        // don't have an audio manager for
        val audioManager =
            voiceChannel.jda.audioManagers.firstOrNull { am ->
                am.guild.id == voiceChannel.guild.id
            }
    ...
    override fun onSlashCommandInteraction(event: SlashCommandInteractionEvent) {
        ...
        try {
            ...
            messageEvent.reply("An internal error occurred while executing the command.", true)
            throw e
        }
    }
}
