...
class CustomGuildRepositoryImpl(private val mongoTemplate: MongoTemplate) : CustomGuildRepository {
    ...
    override fun addToSet(guildId: String, field: String, value: String): SpringGuild? {
    ...
    override fun addModeratorId(guildId: String, userId: String): SpringGuild? {
        return this.addToSet(guildId, SpringGuild::privilegedUsers.name, userId)
    }

    override fun removeModeratorId(guildId: String, userId: String): SpringGuild? {
        return this.removeFromSet(guildId, SpringGuild::privilegedUsers.name, userId)
    }

    override fun addMemeChannelId(guildId: String, channelId: String): SpringGuild? {
        return this.addToSet(guildId, SpringGuild::memeChannels.name, channelId)
    }

    override fun removeMemeChannelId(guildId: String, channelId: String): SpringGuild? {
        return this.removeFromSet(guildId, SpringGuild::memeChannels.name, channelId)
    }

    override fun setXkcdChannelId(guildId: String, channelId: String): SpringGuild? {
        return mongoTemplate.findAndModify(
            query(where(SpringGuild::guildId.name).`is`(guildId)),
    ...
    override fun addDeafenChannelId(guildId: String, channelId: String): SpringGuild? {
        return this.addToSet(guildId, SpringGuild::deafenedChannels.name, channelId)
    }

    override fun removeDeafenChannelId(guildId: String, channelId: String): SpringGuild? {
        return this.removeFromSet(guildId, SpringGuild::deafenedChannels.name, channelId)
    }
